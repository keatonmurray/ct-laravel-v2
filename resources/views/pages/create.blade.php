    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            <div class="card border-0 shadow-lg">
                <div class="card-body py-4 px-md-5 px-4">
                    <h4 class="fw-500">MANAGE YOUR INVENTORY</h4>
                    <div class="clearfix"></div>
                    <hr />
                    <form action="#">
                        <div class="mb-4">
                            <label for="product_name" class="form-label">Product Name</label>
                            <input type="text" class="form-control text-muted small" id="product_name">
                        </div>
                        <div class="mb-4">
                            <label for="qty_in_stock" class="form-label">Quantity In Stock</label>
                            <input type="number" class="form-control text-muted small" id="qty_in_stock">
                        </div>
                        <div class="mb-4">
                            <label for="price_per_item" class="form-label">Price Per Item</label>
                            <input type="number" class="form-control text-muted small" id="price_per_item">
                        </div>
                        <button id="submit" class="btn btn-secondary float-end">Save</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6">
            <div class="card border-0 shadow-lg mt-4 mt-md-0">
                <div class="card-body py-4 px-md-5 px-4">
                    <h5 class="fw-500">LISTED PRODUCTS</h5>
                    <div class="clearfix"></div>
                    <hr />
